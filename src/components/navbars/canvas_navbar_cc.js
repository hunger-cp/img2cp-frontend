    ...
    if (props.isPatternCalculated) {
        if (props.canvasMode == "Canvas") {
            return (
                <div className="flex column">
                    ...
                    <div className="h-12 bg-zinc-100 ">
                        <div onClick = {() => props.setCanvasMode("CreasePattern")} className="h-full w-48 border-r border-bg-zinc-300 flex justify-center items-center text-zinc-500 hover:text-zinc-700 text-lg">Crease Pattern</div>
                    </div>
                </div>
            ...
            return (
                <div className="flex column">
                    <div className="h-12 bg-zinc-100 ">
                        <div onClick = {() => props.setCanvasMode("Canvas")} className="h-full w-48 border-r border-bg-zinc-300 flex justify-center text-zinc-500 hover:text-zinc-700 items-center text-lg">Canvas</div>
                    </div>
                    <div className="h-12 bg-zinc-200">
